...
class WrapperMessage final :
 ...
 public:
  ...
  explicit constexpr WrapperMessage(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class FastResponse final :
 ...
 public:
  ...
  explicit constexpr FastResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class SlowResponse final :
 ...
 public:
  ...
  explicit constexpr SlowResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class RequestForFastResponse final :
 ...
 public:
  ...
  explicit constexpr RequestForFastResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class RequestForSlowResponse final :
 ...
 public:
  ...
  explicit constexpr RequestForSlowResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void WrapperMessage::set_allocated_fast_response(::TestTask::Messages::FastResponse* fast_response) {
  ...
  if (fast_response) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TestTask::Messages::FastResponse>::GetOwningArena(fast_response);
...
inline void WrapperMessage::set_allocated_slow_response(::TestTask::Messages::SlowResponse* slow_response) {
  ...
  if (slow_response) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TestTask::Messages::SlowResponse>::GetOwningArena(slow_response);
    if (message_arena != submessage_arena) {
...
inline void WrapperMessage::set_allocated_request_for_fast_response(::TestTask::Messages::RequestForFastResponse* request_for_fast_response) {
  ...
  if (request_for_fast_response) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TestTask::Messages::RequestForFastResponse>::GetOwningArena(request_for_fast_response);
    if (message_arena != submessage_arena) {
...
inline void WrapperMessage::set_allocated_request_for_slow_response(::TestTask::Messages::RequestForSlowResponse* request_for_slow_response) {
  ...
  if (request_for_slow_response) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::TestTask::Messages::RequestForSlowResponse>::GetOwningArena(request_for_slow_response);
    if (message_arena != submessage_arena) {
...
inline void FastResponse::clear_current_date_time() {
  current_date_time_.ClearToEmpty();
  _has_bits_[0] &= ~0x00000001u;
}
...
void FastResponse::set_current_date_time(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 current_date_time_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void FastResponse::_internal_set_current_date_time(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  current_date_time_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* FastResponse::_internal_mutable_current_date_time() {
  _has_bits_[0] |= 0x00000001u;
  return current_date_time_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* FastResponse::release_current_date_time() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = current_date_time_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (current_date_time_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
